...
<div class="d-flex justify-content-center">
    ...
    <div class="d-flex justify-content-center">
        <form action="actionUsuario.php" method="POST" class="was-validated" enctype="multipart/form-data">
            ...
            <div class="form-floating mt-3 mb-3">
                <input type="text" name="matriculaUsuario" id="matriculaUsuario" placeholder="Insira sua matrícula" class="form-control">
            ...
            <div class="form-floating mt-3 mb-3">
                <input type="password" name="confirmarSenhaUsuario" id="confirmarSenhaUsuario" placeholder="Confirmar Senha" class="form-control" minlength="3" maxlength="8">
